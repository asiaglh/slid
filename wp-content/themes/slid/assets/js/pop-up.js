                    ...
                    <div class="pop-up__scroll">
                        ...
                        <div class="pop-up__row">
                            ...
                            <div class="pop-up__inputs inputs">
                                <input type="text" class="pop-up__ input" placeholder="Імʼя" name="firstname">
                                <input type="text" class="pop-up__input input" placeholder="Прізвище" name="lastname">
                                <input type="text" class="pop-up__input input phone" placeholder="Телефон" name="tel">
